...
def filter_pokemon_():
    ...
    for index, row in filteredData.iterrows():
        ...
        button=ctk.CTkButton(frameButtons,fg_color="#147285",
                               ...
                               gen=gen,
                               leg=leg:
                               on_button_click(name,type1,type2,
                                               hp,atk,defense,
...
def on_button_click(name,type1,type2,hp,atk,defense,spAtk,spDef,spd,gen,leg):
    global currentScene
    remove_pokemon_()
    ...
    pokeAtkLabel.pack(padx=5,pady=5)
    pokeDefLabel.pack(padx=5,pady=5)
    pokeSpAtkLabel.pack(padx=5,pady=5)
    pokeSpDefLabel.pack(padx=5,pady=5)
    pokeSpeedLabel.pack(padx=5,pady=5)
    pokeGenLabel.pack(padx=5,pady=5)
    pokeLegendLabel.pack(padx=5,pady=5)
